...
**分析时间**: 2026-2-14 23:00:00
**告警日志**: 1N-webshell上传.json
**攻击类型**: webshell上传
**研判结论**: 定向攻击
**调查结果**: 确认攻击成功，攻击者通过接口www.cccc.cn//uapim/upload/grouptemplet?groupid=82&fileType=jsp上传webshell上传至服务器，webshell上传的本地路径为/tmp/join/shell.jsp
**处置结果**: 已封禁59.56.48.110攻击IP，已删除服务器上的webshell上传文件/tmp/join/shell.jsp。
...
攻击者通过接口www.cccc.cn//uapim/upload/grouptemplet?groupid=82&fileType=jsp上传webshell上传至服务器，webshell上传的本地路径为/tmp/join/shell.jsp
